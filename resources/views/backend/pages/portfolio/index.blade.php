                        ...
                        <table class="table mb-0  nowrap w-100 dataTable no-footer dtr-inline" id="PortfolioTable">
                            ...
                            @forelse($portfolios as $portfolio)
                                <tr>
                                    ...
                                    <td>
                                        <img class="rounded" src="{{asset($portfolio->portfolio_image)}}" alt=""
                                             width="50" height="50">
                                    </td>
                                    ...
                                    <td>
                                        <button class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#editPortfolioModal{{$portfolio->id}}">Edit
                                        </button>
                                        <button form="deletePortfolio{{$portfolio->id}}" class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#deletePortfolioModal{{$portfolio->id}}">Delete
                                        </button>
                                        <form id="deletePortfolio{{$portfolio->id}}"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post"
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="Portfolio_type" class="col-form-label">Portfolio
                                                            Sequence</label>
                                                        <input type="number" class="form-control"
                                                               value="{{$portfolio->portfolio_sequence}}"
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="email" class="col-form-label">Portfolio
                                                            Title</label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="portfolio_short_desc" class="col-form-label">Portfolio
                                                            Short Description</label>
                                                    <textarea id="portfolio_short_desc" class="form-control"
                                                              name="portfolio_short_desc">{{$portfolio->portfolio_short_desc}} </textarea>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="type" class="col-form-label">Portfolio button
                                                            Text</label>
                                                        <input type="text" class="form-control"
                                                               value="{{$portfolio->portfolio_btn_text}}"
                                                               name="portfolio_btn_text">
                                                    </div>
    ...
    <div class="modal fade" id="createPortfolioModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="form" id="createPortfolio" method="post" action="{{route('admin.portfolio.store')}}"
                        ...
                        <div class="mb-3">
                            <label for="portfolio_short_desc" class="col-form-label">Portfolio
                                Short Description</label>
                            <textarea id="portfolio_short_desc" class="form-control"
                                      name="portfolio_short_desc"> </textarea>
