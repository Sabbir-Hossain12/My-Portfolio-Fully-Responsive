...
<section id="home" class="background1 container-fluid d-flex justify-content-center align-items-center flex-column flex-sm-row flex-md-row flex-lg-row flex-xl-row">
    <div class="img-banner-pos shadow-sm pe-5">
        <img
                class="rounded-circle me-img"
                src="{{asset('frontend')}}/assets/images/Cover/dp.jpg" alt="profile-picture"
        />
    </div>
    <div class="header-big">
        ...
        <!-- NAME AND TITLE -->
        <div>
            <h1 class="header bold strong m-0">SABBIR HOSSAIN</h1>
            <h4 class=" subheader shadow-sm">Web Application Developer</h4>
            <p class="short-des">from Bangladesh with expertise in PHP, Laravel, JQuery and Bootstrap.</p>
        </div>
